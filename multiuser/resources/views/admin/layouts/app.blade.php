  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="/admin/user" class="list-group-item list-group-item-action bg-light"><i class="fas fa-users"></i> Data User</a>
        <a href="/setting" class="list-group-item list-group-item-action bg-light"><i class="fas fa-lock"></i> Ganti Password</a>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
